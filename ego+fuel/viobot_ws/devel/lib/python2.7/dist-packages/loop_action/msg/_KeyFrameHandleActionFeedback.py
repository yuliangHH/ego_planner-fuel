...
"""autogenerated by genpy from loop_action/KeyFrameHandleActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class KeyFrameHandleActionFeedback(genpy.Message):
  _md5sum = "0673ced94ac51d83f9e29e2483dcf813"
  _type = "loop_action/KeyFrameHandleActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','loop_action/KeyFrameHandleFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(KeyFrameHandleActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = loop_action.msg.KeyFrameHandleFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = loop_action.msg.KeyFrameHandleFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.saving,) = _get_struct_I().unpack(str[start:end])
      return self
