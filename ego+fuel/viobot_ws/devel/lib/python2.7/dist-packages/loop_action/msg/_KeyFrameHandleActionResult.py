...
"""autogenerated by genpy from loop_action/KeyFrameHandleActionResult.msg. Do not edit."""
import codecs
import sys
...
class KeyFrameHandleActionResult(genpy.Message):
  _md5sum = "58b0bc8214dfc1c1d771ec57b6431c00"
  _type = "loop_action/KeyFrameHandleActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','loop_action/KeyFrameHandleResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(KeyFrameHandleActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = loop_action.msg.KeyFrameHandleResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = loop_action.msg.KeyFrameHandleResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.keyframe_num,) = _get_struct_I().unpack(str[start:end])
      return self
