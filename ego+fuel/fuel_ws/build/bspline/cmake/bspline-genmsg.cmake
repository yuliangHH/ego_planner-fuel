...
set(MSG_I_FLAGS "-Ibspline:/home/uav1/fuel_ws/src/exploration/FUEL/fuel_planner/bspline/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/uav1/fuel_ws/src/exploration/FUEL/fuel_planner/bspline/msg/Bspline.msg" NAME_WE)
add_custom_target(_bspline_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bspline" "/home/uav1/fuel_ws/src/exploration/FUEL/fuel_planner/bspline/msg/Bspline.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(bspline
  "/home/uav1/fuel_ws/src/exploration/FUEL/fuel_planner/bspline/msg/Bspline.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bspline)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bspline\")")
  # install generated code
  install(
